package com.dq.house.common.result;
...
public enum ResultCodeEnum {
    ...
    ADMIN_APARTMENT_DELETE_ERROR(310, "该公寓下存在房间信息，无法删除"),

    APP_LOGIN_AUTH(501, "未登陆"),
    APP_LOGIN_PHONE_EMPTY(502, "手机号码为空"),
    APP_LOGIN_EMAIL_OR_PHONE_ERROR(502, "邮箱或手机号不匹配"),
    ...
    EMAIL_SEND_ERROR(701, "验证码发送失败"),
    EMAIL_ERROR(701, "邮箱地址不合法");
