...
import com.dq.house.web.admin.service.ApartmentInfoService;
...
public class ApartmentController {
    ...
    public Result<ApartmentDetailVo> getDetailById(@RequestParam Long id) {
        ApartmentDetailVo apartmentDetailVo = apartmentInfoService.getApartmentInfoById(id);
    ...
    public Result updateReleaseStatusById(@RequestParam Long id, @RequestParam ReleaseStatus status) {
        LambdaUpdateWrapper<ApartmentInfo> apartmentWrapper = new LambdaUpdateWrapper<>();
        apartmentWrapper.eq(ApartmentInfo::getId, id);
        apartmentWrapper.set(ApartmentInfo::getIsRelease, status);
        apartmentInfoService.update(apartmentWrapper);
        return Result.ok();
    }
    ...
    public Result<List<ApartmentInfo>> listInfoByDistrictId(@RequestParam Long id) {
        ...
        apartmentWrapper.eq(ApartmentInfo::getDistrictId, id);
        List<ApartmentInfo> apartmentInfos = apartmentInfoService.list(apartmentWrapper);
