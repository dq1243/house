package com.dq.house.web.admin.controller.system;
...
public class SystemUserController {
    ...
    public Result<IPage<SystemUserItemVo>> page(@RequestParam long current, @RequestParam long size, SystemUserQueryVo queryVo) {
        ...
        IPage<SystemUserItemVo> result = systemUserService.itemPage(page, queryVo);
    ...
    public Result<SystemUserItemVo> getById(@RequestParam Long id) {
        SystemUserItemVo userItemVo = systemUserService.getUserById(id);
        return Result.ok(userItemVo);
    }
    ...
    public Result saveOrUpdate(@RequestBody SystemUser systemUser) {
        if (systemUser.getPassword() != null) {
            String paw = DigestUtils.md5Hex(systemUser.getPassword());
            systemUser.setPassword(paw);
        }
    ...
    public Result<Boolean> isUsernameExists(@RequestParam String username) {
        ...
        boolean exists = systemUserService.count(queryWrapper) > 0;
