...
import com.dq.house.model.entity.SystemPost;
import com.dq.house.model.enums.BaseStatus;
import com.dq.house.web.admin.service.SystemPostService;
...
public class SystemPostController {
    ...
    public Result<List<SystemPost>> list() {
        ...
        queryWrapper.eq(SystemPost::getStatus, BaseStatus.ENABLE);
